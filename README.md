...
- **Race template search & contribution** — browse the seven canonical races (Human, Elf, Celestine, Leonid, Runic, Draconian, Smoulder) with their racial abilities, or assemble your own reusable race templates, each pairing a name with exactly six racial abilities.
